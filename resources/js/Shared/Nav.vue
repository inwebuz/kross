<template>
    <nav class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex flex-col lg:flex-row items-center fixed lg:static w-screen h-screen lg:w-auto lg:h-auto" :class="{hidden: isHidden}" >
